...
parser.add_argument("--dataroot", type=str, default="C:/Users/USER",
...
parser.add_argument("--iters", default=1e8, type=int, metavar="N",
                    help="Number of total epochs to run. "
                         ...
                         "(default:1e8)")
parser.add_argument("-b", "--batch-size", default=19, type=int,
                    metavar="N",
...
parser.add_argument("--upscale-factor", type=int, default=2, choices=[2, 3, 4],
...
if __name__ == '__main__':
    ...
    dataset = DatasetFromFolder(input_dir=f"C:/Users/USER/Bicubic/set01_V001_lwir",
                                target_dir=f"C:/Users/USER/dataset/set01/V001/visible")
